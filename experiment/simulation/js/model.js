...
var marxGenerator = [
    ...
    {type: "material", color: {r: 1, g: 1, b: 1},
        nodes: [{type: "translate", y: 2.35, x: -1, z: 2.9,
                nodes: [{type: "rotate", id: "cylinder52", z: 1.0, angle: 95, x: 0.15,
                        nodes: [{type: "prims/cylinder", radiusTop: 0.03, radiusBottom: 0.03, height: 2.5, radialSegments: 50, heightSegments: 1, openEnded: false}]
                    }]
            }]
    },
    {type: "material", color: {r: 1, g: 1, b: 1},
        nodes: [{type: "translate", y: 2.1, x: 2.75, z: 2.1,
                nodes: [{type: "rotate", id: "cylinder53", z: 1.2, angle: 83, x: 0.45,
                        nodes: [{type: "prims/cylinder", radiusTop: 0.03, radiusBottom: 0.03, height: 4.8, radialSegments: 50, heightSegments: 1, openEnded: false}]
                    }]
            }]
    },
    {type: "material", color: {r: 1, g: 1, b: 1},
...
var sceneNodes = {
    nodes: [{type: "lights", id: "myLights", lights: [{mode: "dir", color: {r: 1.0, g: 1.0, b: 1.0}, diffuse: true, specular: true, dir: {x: -5, y: -2, z: -5}, space: "view"}],
            nodes: [{type: "rotate", y: 1, angle: 0, id: "multi", nodes: threeShapes,
                    nodes: [{type: "translate", x: -0.4, y: 0, z: 0.9, id: "multi2", nodes: threeShapes}]
                }]
        },
    {type: "lights", id: "myLights1", lights: [{mode: "dir", color: {r: 1.0, g: 1.0, b: 1.0}, diffuse: true, specular: true, dir: {x: -5, y: -2, z: -5}, space: "view"}],
            nodes: [{type: "rotate", y: 1, angle: 5, id: "multi3", nodes: marxGenerator,
                    nodes: [{type: "translate", x: 1.0, y: 0, z: 2.5, id: "multi4", nodes: marxGenerator}]
                }]
        },
        {type: "lights", id: "myLights3", lights: [{mode: "dir", color: {r: 1.0, g: 1.0, b: 1.0}, diffuse: true, specular: true, dir: {x: -5, y: -2, z: -5}, space: "view"}],
            nodes: [{type: "rotate", y: 1, angle: 0, id: "multi5", nodes: voltageDivider,
                    nodes: [{type: "translate", x: -0.4, y: -0.1, z: 2.75, id: "multi6", nodes: voltageDivider}]
                }]
        }
    ]
};
